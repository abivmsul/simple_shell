#include "main.h"
/**
 * check_if_match - checks if a character matches,
 * any in a string.
...
/**
 * build_path - Combines two strings one representing,
 * the path directory and,
 ...
 * Return: Upon success a string representing the,
