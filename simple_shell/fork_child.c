...
/**
 * fork_child - Creates a child in  order to execute,
 * another program.
 * @vars: A structure cointaining a array of pointers,
 * and a string.
 */
...
/**
 * path_finder - Acts as an interface for functions,
 * that will be able,
 ...
 * Return: Upon success returns the index,
 * of the environmental variale,
 * otherwise returns -1.
 */
...
/**
 * search_directories - Looks through directories,
 * stored in path_tokens,
 * for a specific file aka command.
 * @path_tokens: A pointer to array of strings,
 * containings the paths,
 * contained in the PATH environment variable.
 * @command: Represents a command. i.e. ls, /bin/ls,
 * pwd, etc.
 *
 * Return: On success a string with the directory,
 * containing the,
